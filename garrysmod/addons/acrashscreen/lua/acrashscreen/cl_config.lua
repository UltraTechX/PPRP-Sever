...
-- Your community name
_this.communityName = "The Opifex Network"
...
_this.backgroundUrls = {
	{ 
		"https://opifexdev.net/server/gmod/powerplantrp/termload/strech.png", -- Image URL
...
-- The web-based chat
-- Set this to false if you want this disabled
_this.chatURL = "https://opifexdev.net/server/gmod/powerplantrp/acrashscreen/chat/chat.php"

-- Chat user properties: nick names and noticable messages
local ranks = {}
ranks[ 'Owner' ] = { Color( 125, 0, 180 ), true } -- { nick name color, if true user can use ! in front of their text to type a noticable message }
